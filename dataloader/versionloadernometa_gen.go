...
type VersionLoaderNoMeta struct {
	...
	batch *versionLoaderNoMetaBatch

	// mutex to prevent races
	mu sync.Mutex
}

type versionLoaderNoMetaBatch struct {
	keys    []string
...
func (l *VersionLoaderNoMeta) LoadThunk(key string) func() ([]postgres.Version, error) {
	...
	if l.batch == nil {
		l.batch = &versionLoaderNoMetaBatch{done: make(chan struct{})}
	}
	batch := l.batch
...
func (l *VersionLoaderNoMeta) unsafeSet(key string, value []postgres.Version) {
	if l.cache == nil {
...
func (b *versionLoaderNoMetaBatch) keyIndex(l *VersionLoaderNoMeta, key string) int {
...
func (b *versionLoaderNoMetaBatch) startTimer(l *VersionLoaderNoMeta) {
	time.Sleep(l.wait)
	l.mu.Lock()
...
func (b *versionLoaderNoMetaBatch) end(l *VersionLoaderNoMeta) {

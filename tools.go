...
//go:generate go run github.com/99designs/gqlgen@v0.17.70 generate
//go:generate go run github.com/jmattheis/goverter/cmd/goverter@v1.8.2 gen -g wrapErrors -g ignoreUnexported ./conversion
//go:generate go run github.com/swaggo/swag/cmd/swag@v1.16.4 init --generalInfo cmd/api/serve.go --output ./generated/docs

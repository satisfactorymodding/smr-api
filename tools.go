...
//go:generate go run github.com/jmattheis/goverter/cmd/goverter@v1.4.0 gen -g wrapErrors -g ignoreUnexported ./conversion
//go:generate go run github.com/swaggo/swag/cmd/swag@v1.16.3 init --generalInfo cmd/api/serve.go --output ./generated/docs

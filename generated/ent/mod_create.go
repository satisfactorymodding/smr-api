...
func (mc *ModCreate) SetAiUseDisclosure(uudi *util.AIUseDisclosureInfo) *ModCreate {
	mc.mutation.SetAiUseDisclosure(uudi)
	return mc
}
...
// SetAiUseDisclosure sets the "ai_use_disclosure" field.
func (u *ModUpsert) SetAiUseDisclosure(v *util.AIUseDisclosureInfo) *ModUpsert {
...
// SetAiUseDisclosure sets the "ai_use_disclosure" field.
func (u *ModUpsertOne) SetAiUseDisclosure(v *util.AIUseDisclosureInfo) *ModUpsertOne {
	return u.Update(func(s *ModUpsert) {
...
// SetAiUseDisclosure sets the "ai_use_disclosure" field.
func (u *ModUpsertBulk) SetAiUseDisclosure(v *util.AIUseDisclosureInfo) *ModUpsertBulk {
	return u.Update(func(s *ModUpsert) {
		s.SetAiUseDisclosure(v)
	})
}

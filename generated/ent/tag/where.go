...
func HasModsWith(preds ...predicate.Mod) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := newModsStep()
...
func HasGuidesWith(preds ...predicate.Guide) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := newGuidesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasModTagsWith(preds ...predicate.ModTag) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := newModTagsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasGuideTags() predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),

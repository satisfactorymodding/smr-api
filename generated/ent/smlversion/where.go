...
func CreatedAtIsNil() predicate.SmlVersion {
	return predicate.SmlVersion(sql.FieldIsNull(FieldCreatedAt))
}

// CreatedAtNotNil applies the NotNil predicate on the "created_at" field.
func CreatedAtNotNil() predicate.SmlVersion {
	return predicate.SmlVersion(sql.FieldNotNull(FieldCreatedAt))
}
...
func UpdatedAtIsNil() predicate.SmlVersion {
	return predicate.SmlVersion(sql.FieldIsNull(FieldUpdatedAt))
}

// UpdatedAtNotNil applies the NotNil predicate on the "updated_at" field.
func UpdatedAtNotNil() predicate.SmlVersion {
	return predicate.SmlVersion(sql.FieldNotNull(FieldUpdatedAt))
}
